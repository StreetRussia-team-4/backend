    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='media_content.image', to_field='image', verbose_name='Логотип')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='partners', to='about.partnertype', verbose_name='Тип партнера')),
            ],
            options={
